...
-- Call om emp 200340 Roy
    DBMS_OUTPUT.PUT_LINE('Call om emp 200340 Roy:');
...
-- Call om emp 200330 Helena
    DBMS_OUTPUT.PUT_LINE('Call om emp 200330 Helena:');
    DBMS_OUTPUT.PUT_LINE('--------------------------------');
    salary(200330, 2);
    DBMS_OUTPUT.PUT_LINE('--------------------------------');
    DBMS_OUTPUT.NEW_LINE;
...
-- Call om emp 200310 Michelle
    DBMS_OUTPUT.PUT_LINE('Call om emp 200310 Michelle:');
    DBMS_OUTPUT.PUT_LINE('--------------------------------');
    salary(200310, 3);
    DBMS_OUTPUT.PUT_LINE('--------------------------------');
    DBMS_OUTPUT.NEW_LINE;
